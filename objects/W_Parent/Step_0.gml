...
var areaInicial = instance_place(x, y, obj_AreaInicialW)
var areaInimiga = instance_place(x, y, obj_AreaInicialT)
var pecaR = instance_place(x, y, W_Parent)
var pecaC = instance_place(x, y, T_Parent)
